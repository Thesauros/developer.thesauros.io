...
export class StoreService implements OnModuleInit {
  ...
  private buildVaults(): VaultEntity[] {
    return [
      ...
      { id: 'vault_plasma_usdt0', object: 'vault', name: 'Thesauros USDT0 Vault', provider: 'morpho', asset: 'USDT0', chain: 'plasma', apy: 0.076, apy_7d_avg: 0.073, apy_30d_avg: 0.07, tvl_usd: 12_800_000, capacity_usd: 40_000_000, risk_tier: 'core', status: 'active', allocation_pct: 0.07 },
